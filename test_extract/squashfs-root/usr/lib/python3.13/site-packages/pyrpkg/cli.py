...
class cliClient(object):
    ...
    def load_cmd(self):
        ...
        # Set koji_offline if we got it as an option
        koji_offline = None
        if hasattr(self.args, 'koji_offline') and self.args.koji_offline:
            koji_offline = self.args.koji_offline
    ...
    def mock_config(self):
        print(self.cmd.mock_config(self.args.target, self.args.arch, standalone=True))
