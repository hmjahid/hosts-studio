...
class QSctpServer(PySide6.QtNetwork.QTcpServer):

    def __init__(self, /, parent: PySide6.QtCore.QObject | None = ...) -> None: ...

    def incomingConnection(self, handle: int, /) -> None: ...
    def maximumChannelCount(self, /) -> int: ...
    def nextPendingDatagramConnection(self, /) -> PySide6.QtNetwork.QSctpSocket: ...
    def setMaximumChannelCount(self, count: int, /) -> None: ...


class QSctpSocket(PySide6.QtNetwork.QTcpSocket):

    def __init__(self, /, parent: PySide6.QtCore.QObject | None = ...) -> None: ...

    def close(self, /) -> None: ...
    def disconnectFromHost(self, /) -> None: ...
    def isInDatagramMode(self, /) -> bool: ...
    def maximumChannelCount(self, /) -> int: ...
    def readData(self, maxlen: int, /) -> object: ...
    def readDatagram(self, /) -> PySide6.QtNetwork.QNetworkDatagram: ...
    def readLineData(self, maxlen: int, /) -> object: ...
    def setMaximumChannelCount(self, count: int, /) -> None: ...
    def writeDatagram(self, datagram: PySide6.QtNetwork.QNetworkDatagram | PySide6.QtCore.QByteArray, /) -> bool: ...
