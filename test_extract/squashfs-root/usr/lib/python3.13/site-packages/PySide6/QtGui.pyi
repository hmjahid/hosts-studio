...
class QImage(PySide6.QtGui.QPaintDevice):
    ...
    def bits(self, /) -> typing.Union[bytes, bytearray, memoryview]: ...
    ...
    def constBits(self, /) -> typing.Union[bytes, bytearray, memoryview]: ...
...
class QOpenGLFunctions(Shiboken.Object):
    ...
    def glGetShaderSource(self, shader: int, /) -> typing.Union[bytes, bytearray, memoryview]: ...
...
class QRhi(Shiboken.Object):
    ...
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    @staticmethod
    def backendName(impl: PySide6.QtGui.QRhi.Implementation, /) -> typing.Union[bytes, bytearray, memoryview]: ...  # type: ignore[misc, overload-cannot-match]
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    def backendName(self, /) -> typing.Union[bytes, bytearray, memoryview]: ...  # type: ignore[misc, overload-cannot-match]
