...
class NetworksFirmwareUpgradesStagedEvents(object):
    ...
    def create_params(self):
        ...
        if self.new_object.get('stages') is not None or self.new_object.get('stages') is not None:
            new_object_params['stages'] = self.new_object.get('stages') or \
                self.new_object.get('stages')
        if self.new_object.get('networkId') is not None or self.new_object.get('network_id') is not None:
            new_object_params['networkId'] = self.new_object.get('networkId') or \
                self.new_object.get('network_id')
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="networks",
                function="getNetworkFirmwareUpgradesStagedEvents",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="networks",
            function="updateNetworkFirmwareUpgradesStagedEvents",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksFirmwareUpgradesStagedEvents(self._task.args, meraki)
