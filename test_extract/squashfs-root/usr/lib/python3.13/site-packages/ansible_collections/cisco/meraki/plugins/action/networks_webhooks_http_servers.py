...
required_if = [
    ("state", "present", ["httpServerId", "name", "networkId"], True),
    ("state", "absent", ["httpServerId", "name", "networkId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class NetworksWebhooksHttpServers(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="networks",
                function="getNetworkWebhooksHttpServers",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="networks",
                function="getNetworkWebhooksHttpServer",
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "http_server_id") or self.new_object.get("httpServerId")
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksWebhooksHttpServers(self._task.args, meraki)
