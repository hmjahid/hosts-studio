...
required_if = [
    ("state", "present", ["mqttBrokerId", "networkId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class NetworksSensorMqttBrokers(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="sensor",
                function="getNetworkSensorMqttBrokers",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="sensor",
                function="getNetworkSensorMqttBroker",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="sensor",
            function="updateNetworkSensorMqttBroker",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksSensorMqttBrokers(self._task.args, meraki)
