...
required_if = [
    ("state", "present", ["name", "serial", "staticRouteId"], True),
    ("state", "absent", ["name", "serial", "staticRouteId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class DevicesSwitchRoutingStaticRoutes(object):
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DevicesSwitchRoutingStaticRoutes(self._task.args, meraki)
