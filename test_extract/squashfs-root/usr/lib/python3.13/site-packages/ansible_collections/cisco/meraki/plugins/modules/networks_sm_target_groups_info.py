...
options:
  ...
  withDetails:
    description:
    - >
      WithDetails query parameter. Boolean indicating if the the ids of the devices or users scoped by the target
      group should be included in the response.
    type: bool
  targetGroupId:
    description:
...
notes:
  - SDK Method used are
    sm.Sm.get_network_sm_target_group,
    sm.Sm.get_network_sm_target_groups,
