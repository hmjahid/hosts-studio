...
class NetworksFirmwareUpgradesStagedStages(object):
    ...
    def update_all_params(self):
        new_object_params = {}
        if self.new_object.get('_json') is not None or self.new_object.get('_json') is not None:
            new_object_params['_json'] = self.new_object.get('_json') or \
                self.new_object.get('_json')
        if self.new_object.get('networkId') is not None or self.new_object.get('network_id') is not None:
            new_object_params['networkId'] = self.new_object.get('networkId') or \
                self.new_object.get('network_id')
        return new_object_params
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksFirmwareUpgradesStagedStages(self._task.args, meraki)
