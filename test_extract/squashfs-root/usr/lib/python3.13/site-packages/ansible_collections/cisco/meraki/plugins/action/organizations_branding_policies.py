...
required_if = [
    ("state", "present", ["brandingPolicyId", "name", "organizationId"], True),
    ("state", "absent", ["brandingPolicyId", "name", "organizationId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class OrganizationsBrandingPolicies(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                ...
                function="getOrganizationBrandingPolicies",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="organizations",
                function="getOrganizationBrandingPolicy",
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "branding_policy_id") or self.new_object.get("brandingPolicyId")
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="deleteOrganizationBrandingPolicy",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsBrandingPolicies(self._task.args, meraki)
