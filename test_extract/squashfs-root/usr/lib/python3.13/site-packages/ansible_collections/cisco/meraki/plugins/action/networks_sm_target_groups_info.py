...
class ActionModule(ActionBase):
    ...
    def get_object(self, params):
        ...
        if params.get("networkId") is not None:
            new_object["networkId"] = params.get(
                "networkId")
        if params.get("targetGroupId") is not None:
            new_object["targetGroupId"] = params.get(
                "targetGroupId")
        if params.get("withDetails") is not None:
            new_object["withDetails"] = params.get(
                "withDetails")
        return new_object
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        id = self._task.args.get("targetGroupId")
        if id:
