...
class NetworksApplianceFirewallCellularFirewallRules(object):
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="appliance",
            function="updateNetworkApplianceFirewallCellularFirewallRules",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksApplianceFirewallCellularFirewallRules(self._task.args, meraki)
