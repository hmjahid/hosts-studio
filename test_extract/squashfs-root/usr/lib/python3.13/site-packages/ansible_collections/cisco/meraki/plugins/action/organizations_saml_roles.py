...
required_if = [
    ("state", "present", ["organizationId", "role", "samlRoleId"], True),
    ("state", "absent", ["organizationId", "role", "samlRoleId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class OrganizationsSamlRoles(object):
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "saml_role_id") or self.new_object.get("samlRoleId")
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="deleteOrganizationSamlRole",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsSamlRoles(self._task.args, meraki)
