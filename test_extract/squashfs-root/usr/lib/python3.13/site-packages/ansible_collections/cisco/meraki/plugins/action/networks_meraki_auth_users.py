...
required_if = [
    ("state", "present", ["merakiAuthUserId", "name", "networkId"], True),
    ("state", "absent", ["merakiAuthUserId", "name", "networkId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class NetworksMerakiAuthUsers(object):
    ...
    def get_params_by_id(self, name=None, id=None):
        ...
        if self.new_object.get('merakiAuthUserId') is not None or self.new_object.get('meraki_auth_user_id') is not None:
            new_object_params['merakiAuthUserId'] = self.new_object.get('merakiAuthUserId') or \
                self.new_object.get('meraki_auth_user_id')
        return new_object_params
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "meraki_auth_user_id") or self.new_object.get("merakiAuthUserId")
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="networks",
            function="deleteNetworkMerakiAuthUser",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksMerakiAuthUsers(self._task.args, meraki)
