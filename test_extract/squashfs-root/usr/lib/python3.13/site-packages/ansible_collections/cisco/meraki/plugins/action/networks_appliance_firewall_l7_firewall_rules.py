...
class NetworksApplianceFirewallL7FirewallRules(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="appliance",
                function="getNetworkApplianceFirewallL7FirewallRules",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="appliance",
            function="updateNetworkApplianceFirewallL7FirewallRules",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksApplianceFirewallL7FirewallRules(self._task.args, meraki)
