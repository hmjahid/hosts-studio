...
required_if = [
    ("state", "present", ["id", "name", "organizationId"], True),
    ("state", "absent", ["id", "name", "organizationId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class OrganizationsAdaptivePolicyGroups(object):
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="deleteOrganizationAdaptivePolicyGroup",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsAdaptivePolicyGroups(self._task.args, meraki)
