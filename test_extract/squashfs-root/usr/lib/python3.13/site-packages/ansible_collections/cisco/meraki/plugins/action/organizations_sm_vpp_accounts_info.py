...
class ActionModule(ActionBase):
    ...
    def get_object(self, params):
        ...
        if params.get("organizationId") is not None:
            new_object["organizationId"] = params.get(
                "organizationId")
        if params.get("vppAccountId") is not None:
            new_object["vppAccountId"] = params.get(
                "vppAccountId")
        return new_object
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        id = self._task.args.get("vppAccountId")
        if id:
            response = meraki.exec_meraki(
                family="sm",
                function='getOrganizationSmVppAccount',
