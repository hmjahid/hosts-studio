...
argument_spec.update(dict(
    ...
    attemptId=dict(type="str"),
))

required_if = [
    ("state", "present", ["attemptId", "networkId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class NetworksSmBypassActivationLockAttempts(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="sm",
                function="getNetworkSmBypassActivationLockAttempt",
    ...
    def create(self):
        result = self.meraki.exec_meraki(
            family="sm",
            function="createNetworkSmBypassActivationLockAttempt",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksSmBypassActivationLockAttempts(self._task.args, meraki)
