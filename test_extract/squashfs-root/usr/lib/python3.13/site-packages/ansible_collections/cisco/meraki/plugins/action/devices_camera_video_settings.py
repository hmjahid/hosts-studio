...
argument_spec.update(dict(
    ...
    externalRtspEnabled=dict(type="bool"),
...
class DevicesCameraVideoSettings(object):
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(
            externalRtspEnabled=params.get("externalRtspEnabled"),
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="camera",
                function="getDeviceCameraVideoSettings",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="camera",
            function="updateDeviceCameraVideoSettings",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DevicesCameraVideoSettings(self._task.args, meraki)
