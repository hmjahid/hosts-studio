...
argument_spec.update(dict(
    ...
    sourceIps=dict(type="list"),
    adminIds=dict(type="list"),
    ...
    def get_all(self, params):
        ...
        if params.get("operationIds") is not None:
            new_object["operationIds"] = params.get(
                "operationIds")
        if params.get("sourceIps") is not None:
            new_object["sourceIps"] = params.get(
                "sourceIps")
        if params.get("adminIds") is not None:
            new_object["adminIds"] = params.get(
                "adminIds")
