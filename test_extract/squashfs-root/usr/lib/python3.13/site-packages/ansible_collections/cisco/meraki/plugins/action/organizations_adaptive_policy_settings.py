...
argument_spec.update(dict(
    ...
    enabledNetworks=dict(type="list"),
...
class OrganizationsAdaptivePolicySettings(object):
    ...
    def update_all_params(self):
        new_object_params = {}
        if self.new_object.get('enabledNetworks') is not None or self.new_object.get('enabled_networks') is not None:
            new_object_params['enabledNetworks'] = self.new_object.get('enabledNetworks') or \
                self.new_object.get('enabled_networks')
        if self.new_object.get('organizationId') is not None or self.new_object.get('organization_id') is not None:
            new_object_params['organizationId'] = self.new_object.get('organizationId') or \
                self.new_object.get('organization_id')
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                ...
                function="getOrganizationAdaptivePolicySettings",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="updateOrganizationAdaptivePolicySettings",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsAdaptivePolicySettings(self._task.args, meraki)
