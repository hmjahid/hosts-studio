...
options:
  ...
  fields:
    description:
    - >
      Fields query parameter. Partial selection If present, this call will return only the selected fields of
      "rawDistribution", "avg". All fields will be returned by default. Selected fields must be entered as a comma
      separated string.
    type: str
requirements:
- meraki >= 2.4.9
- python >= 3.5
seealso:
- name: Cisco Meraki documentation for wireless getNetworkWirelessClientLatencyStats
  description: Complete reference of the getNetworkWirelessClientLatencyStats API.
  link: https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-client-latency-stats
notes:
  - SDK Method used are
    wireless.Wireless.get_network_wireless_client_latency_stats,
...
EXAMPLES = r"""
- name: Get all networks _wireless _clients _latencystats
