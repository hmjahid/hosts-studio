...
options:
    ...
    suboptions:
      appliesTo:
        description: Which kinds of admins this policy applies to. Can be one of 'All
          ...
          admins of networks...', 'All admins of networks tagged...', 'Specific admins...',
          'All admins' or 'All SAML admins'.
        type: str
      values:
  ...
  helpSettings:
    description: Settings for describing the modifications to various Help page features.
      ...
      functionality), 'hide' (remove the section from Dashboard), or 'show' (always
      show the section on Dashboard). Some properties in this object also accept custom
      HTML used to replace the section on Dashboard; see the documentation for each
      property to see the allowed values. Each property defaults to 'default or inherit'
      when not provided.
    suboptions:
      apiDocsSubtab:
      ...
      ciscoMerakiProductDocumentation:
        description: The 'Product Manuals' section of the 'Help -> Get Help' subtab.
          Can be one of 'default or inherit', 'hide', 'show', or a replacement custom
          HTML string.
        type: str
      communitySubtab:
        description: The 'Help -> Community' subtab which provides a link to Meraki
          Community. Can be one of 'default or inherit', 'hide' or 'show'.
        type: str
      dataProtectionRequestsSubtab:
        description: The 'Help -> Data protection requests' Dashboard subtab on which
          requests to delete, restrict, or export end-user data can be audited. Can
      ...
      helpWidget:
        description: The 'Help Widget' is a support widget which provides access to
          live chat, documentation links, Sales contact info, and other contact avenues
          to reach Meraki Support. Can be one of 'default or inherit', 'hide' or 'show'.
        type: str
      newFeaturesSubtab:
        description: The 'Help -> New features' subtab where new Dashboard features
      ...
      supportContactInfo:
        description: The 'Contact Meraki Support' section of the 'Help -> Get Help'
          subtab. Can be one of 'default or inherit', 'hide', 'show', or a replacement
          custom HTML string.
        type: str
