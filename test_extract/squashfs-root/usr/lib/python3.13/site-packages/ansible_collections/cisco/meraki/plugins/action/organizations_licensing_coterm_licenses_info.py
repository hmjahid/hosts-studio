    ...
    def get_all(self, params):
        ...
        if params.get("endingBefore") is not None:
            new_object["endingBefore"] = params.get(
                "endingBefore")
        if params.get("invalidated") is not None:
            new_object["invalidated"] = params.get(
                "invalidated")
        if params.get("expired") is not None:
            new_object["expired"] = params.get(
                "expired")
