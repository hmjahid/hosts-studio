...
class NetworksCellularGatewayConnectivityMonitoringDestinations(object):
    ...
    def update_all_params(self):
        ...
        if self.new_object.get('destinations') is not None or self.new_object.get('destinations') is not None:
            new_object_params['destinations'] = self.new_object.get('destinations') or \
                self.new_object.get('destinations')
        if self.new_object.get('networkId') is not None or self.new_object.get('network_id') is not None:
            new_object_params['networkId'] = self.new_object.get('networkId') or \
                self.new_object.get('network_id')
        return new_object_params
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="cellulargateway",
            function="updateNetworkCellularGatewayConnectivityMonitoringDestinations",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksCellularGatewayConnectivityMonitoringDestinations(self._task.args, meraki)
