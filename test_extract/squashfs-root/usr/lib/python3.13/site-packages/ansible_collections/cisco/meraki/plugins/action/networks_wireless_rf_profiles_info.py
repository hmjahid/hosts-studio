...
argument_spec.update(dict(
    ...
    includeTemplateProfiles=dict(type="bool"),
...
class ActionModule(ActionBase):
    ...
    def get_object(self, params):
        ...
        if params.get("networkId") is not None:
            new_object["networkId"] = params.get(
                "networkId")
        if params.get("rfProfileId") is not None:
            new_object["rfProfileId"] = params.get(
                "rfProfileId")
        return new_object
    ...
    def get_all(self, params):
        ...
        if params.get("networkId") is not None:
            new_object["networkId"] = params.get(
                "networkId")
        if params.get("includeTemplateProfiles") is not None:
            new_object["includeTemplateProfiles"] = params.get(
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        id = self._task.args.get("rfProfileId")
        if id:
