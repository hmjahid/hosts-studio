...
options:
  ...
  timespan:
    ...
    - >
      ...
      default is 31 days. If interval is provided, the timespan will be autocalculated.
    type: float
  interval:
    description:
    - >
      Interval query parameter. The time interval in seconds for returned data. The valid intervals are 120, 3600,
      14400, 21600. The default is 21600. Interval is calculated if time params are provided.
    type: int
  version:
    description:
  ...
  userAgent:
    description:
    - >
      UserAgent query parameter. Filter by user agent string for API request. This will filter by a complete or
      partial match.
    type: str
requirements:
- meraki >= 2.4.9
