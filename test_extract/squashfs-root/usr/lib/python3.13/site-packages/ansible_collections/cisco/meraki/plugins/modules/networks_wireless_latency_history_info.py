...
- name: Cisco Meraki documentation for wireless getNetworkWirelessLatencyHistory
  description: Complete reference of the getNetworkWirelessLatencyHistory API.
  link: https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-latency-history
notes:
  - SDK Method used are
    wireless.Wireless.get_network_wireless_latency_history,
