...
class OrganizationsInsightMonitoredMediaServers(object):
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "monitored_media_server_id") or self.new_object.get("monitoredMediaServerId")
        ...
        if name_exists:
            _id = prev_obj.get("id")
            _id = _id or prev_obj.get("monitoredMediaServerId")
            if id_exists and name_exists and o_id != _id:
                raise InconsistentParameters(
                    "The 'id' and 'name' params don't refer to the same object")
            if _id:
                self.new_object.update(dict(id=_id))
                self.new_object.update(dict(monitoredMediaServerId=_id))
            if _id:
    ...
    def update(self):
        ...
        id = id or self.new_object.get("monitoredMediaServerId")
        name = self.new_object.get("name")
        result = None
        if not id:
            ...
            if prev_obj_name:
                ...
                id_ = id_ or prev_obj_name.get("monitoredMediaServerId")
            if id_:
                self.new_object.update(dict(monitoredMediaServerId=id_))
        result = self.meraki.exec_meraki(
            family="insight",
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="insight",
            function="deleteOrganizationInsightMonitoredMediaServer",
