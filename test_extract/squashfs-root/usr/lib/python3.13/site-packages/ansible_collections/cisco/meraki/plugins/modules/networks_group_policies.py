...
options:
  bandwidth:
    ...
    type: dict
  bonjourForwarding:
    description: The Bonjour settings for your group policy. Only valid if your network
  ...
  firewallAndTrafficShaping:
    ...
    suboptions:
      ...
      l7FirewallRules:
        ...
        type: list
      settings:
        description: How firewall and traffic shaping rules are enforced. Can be 'network
            ...
            suboptions:
              bandwidthLimits:
                description: The bandwidth limits object, specifying the upload ('limitUp')
                  and download ('limitDown') speed in Kbps. These are only enforced
