...
description:
- Manage operations create, update and delete of the resource networks _switch _stacks _routing _staticroutes.
...
options:
  ...
  networkId:
    ...
    type: str
  nextHopIp:
    description: IP address of the next hop device to which the device sends its traffic
      for the subnet.
    type: str
  ...
  staticRouteId:
    ...
    type: str
  subnet:
    description: The subnet which is routed via this static route and should be specified
...
notes:
  - SDK Method used are
    ...
    switch.Switch.delete_network_switch_stack_routing_static_route,
    switch.Switch.update_network_switch_stack_routing_static_route,
