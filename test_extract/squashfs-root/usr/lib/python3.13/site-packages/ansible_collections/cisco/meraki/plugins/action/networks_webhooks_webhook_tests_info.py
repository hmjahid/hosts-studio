...
class ActionModule(ActionBase):
    ...
    def get_object(self, params):
        ...
        if params.get("networkId") is not None:
            new_object["networkId"] = params.get(
                "networkId")
        if params.get("webhookTestId") is not None:
            new_object["webhookTestId"] = params.get(
                "webhookTestId")
        return new_object
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        id = self._task.args.get("webhookTestId")
        if id:
            response = meraki.exec_meraki(
                family="networks",
                function='getNetworkWebhooksWebhookTest',
