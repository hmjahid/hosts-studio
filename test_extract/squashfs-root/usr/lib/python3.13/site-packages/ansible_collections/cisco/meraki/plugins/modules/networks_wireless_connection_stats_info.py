...
short_description: Information module for networks _wireless _connectionstats
description:
- Get all networks _wireless _connectionstats.
...
EXAMPLES = r"""
- name: Get all networks _wireless _connectionstats
