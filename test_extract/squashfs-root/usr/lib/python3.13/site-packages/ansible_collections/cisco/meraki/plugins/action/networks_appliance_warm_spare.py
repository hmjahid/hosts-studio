...
argument_spec.update(dict(
    ...
    spareSerial=dict(type="str"),
    uplinkMode=dict(type="str"),
    virtualIp1=dict(type="str"),
    virtualIp2=dict(type="str"),
...
class NetworksApplianceWarmSpare(object):
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(
            enabled=params.get("enabled"),
            spareSerial=params.get("spareSerial"),
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="appliance",
                function="getNetworkApplianceWarmSpare",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksApplianceWarmSpare(self._task.args, meraki)
