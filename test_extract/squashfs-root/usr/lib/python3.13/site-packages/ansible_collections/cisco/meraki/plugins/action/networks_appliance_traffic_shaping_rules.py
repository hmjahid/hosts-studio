...
class NetworksApplianceTrafficShapingRules(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="appliance",
                function="getNetworkApplianceTrafficShapingRules",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="appliance",
            function="updateNetworkApplianceTrafficShapingRules",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksApplianceTrafficShapingRules(self._task.args, meraki)
