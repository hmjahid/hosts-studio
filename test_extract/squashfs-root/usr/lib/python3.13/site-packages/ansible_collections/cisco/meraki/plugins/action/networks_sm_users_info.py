...
argument_spec.update(dict(
    ...
    ids=dict(type="list"),
    usernames=dict(type="list"),
    emails=dict(type="list"),
    ...
    def get_all(self, params):
        ...
        if params.get("ids") is not None:
            new_object["ids"] = params.get(
                "ids")
        if params.get("usernames") is not None:
            new_object["usernames"] = params.get(
                "usernames")
        if params.get("emails") is not None:
            new_object["emails"] = params.get(
                "emails")
