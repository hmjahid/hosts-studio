...
class NetworksApplianceVpnSiteToSiteVpn(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="appliance",
                function="getNetworkApplianceVpnSiteToSiteVpn",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksApplianceVpnSiteToSiteVpn(self._task.args, meraki)
