...
options:
  ...
  networkIds:
    description:
    - >
      NetworkIds query parameter. Optional parameter to filter device uplinks by network ID. This filter uses
  ...
  productTypes:
    description:
    - >
      ProductTypes query parameter. Optional parameter to filter device uplinks by device product types. This
  ...
  serials:
    description:
    - >
      Serials query parameter. Optional parameter to filter device availabilities by device serial numbers. This
      filter uses multiple exact matches.
    elements: str
    type: list
  tags:
    ...
    - >
      ...
      tags are included, 'tagsFilterType' should also be included (see below). This filter uses multiple exact
      matches.
    elements: str
    type: list
  tagsFilterType:
