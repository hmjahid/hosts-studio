...
required_if = [
    ("state", "present", ["id", "organizationId"], True),
    ("state", "absent", ["id", "organizationId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class OrganizationsAdaptivePolicyPolicies(object):
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="deleteOrganizationAdaptivePolicyPolicy",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsAdaptivePolicyPolicies(self._task.args, meraki)
