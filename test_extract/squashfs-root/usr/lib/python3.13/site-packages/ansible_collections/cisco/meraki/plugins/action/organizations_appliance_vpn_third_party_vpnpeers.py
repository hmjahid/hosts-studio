...
class OrganizationsApplianceVpnThirdPartyVpnpeers(object):
    ...
    def update_all_params(self):
        new_object_params = {}
        if self.new_object.get('peers') is not None or self.new_object.get('peers') is not None:
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsApplianceVpnThirdPartyVpnpeers(self._task.args, meraki)
