...
class NetworksWirelessSsidsBonjourForwarding(object):
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="wireless",
            function="updateNetworkWirelessSsidBonjourForwarding",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksWirelessSsidsBonjourForwarding(self._task.args, meraki)
