...
required_if = [
    ("state", "present", ["id", "name", "networkId"], True),
    ("state", "absent", ["id", "name", "networkId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class NetworksSensorAlertsProfiles(object):
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="sensor",
            function="deleteNetworkSensorAlertsProfile",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksSensorAlertsProfiles(self._task.args, meraki)
