...
def vpn_ipsec_forticlient(data, fos, check_mode=False):
    ...
    data_copy = data.copy()
    data_copy["vpn_ipsec_forticlient"] = converted_data
...
versioned_schema = {
    ...
    "elements": "dict",
    "children": {
        "realm": {"v_range": [["v6.0.0", ""]], "type": "string", "required": True},
        "usergroupname": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "phase2name": {"v_range": [["v6.0.0", ""]], "type": "string"},
        "status": {
            "v_range": [["v6.0.0", ""]],
            "type": "string",
