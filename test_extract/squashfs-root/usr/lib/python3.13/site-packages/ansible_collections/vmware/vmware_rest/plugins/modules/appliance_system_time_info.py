...
RETURN = r"""
# content generated by the update_return_section callback# task: Get the current time
value:
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/api/appliance/system/time").format(**params)
