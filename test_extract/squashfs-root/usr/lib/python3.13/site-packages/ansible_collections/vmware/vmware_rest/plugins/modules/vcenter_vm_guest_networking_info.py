...
RETURN = r"""
# content generated by the update_return_section callback# task: Get guest networking information
value:
...
def build_url(params):
    return (
        "https://{vcenter_hostname}" "/api/vcenter/vm/{vm}/guest/networking"
    ).format(**params)
