...
RETURN = r"""
# content generated by the update_return_section callback# task: Get the vSphere content syncrhronization configuration
value:
  description: Get the vSphere content syncrhronization configuration
  returned: On success
  sample:
