...
short_description: Get IPv6 network configuration for specific interface.
...
RETURN = r"""
# content generated by the update_return_section callback# task: Collect the IPv6 network information
value:
