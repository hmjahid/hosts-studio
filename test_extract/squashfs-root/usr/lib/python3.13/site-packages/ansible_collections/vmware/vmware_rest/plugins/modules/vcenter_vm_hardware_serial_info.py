...
RETURN = r"""
# content generated by the update_return_section callback# task: Get an existing serial port (label)
id:
  ...
  type: str
value:
  description: Get an existing serial port (label)
  returned: On success
  sample:
...
def build_url(params):
    ...
    if params.get("port"):
        ...
        return yarl.URL(
            (
                "https://{vcenter_hostname}" "/api/vcenter/vm/{vm}/hardware/serial/"
            ).format(**params)
            + params["port"]
    ...
    return yarl.URL(
        ("https://{vcenter_hostname}" "/api/vcenter/vm/{vm}/hardware/serial").format(
            **params
        )
        + gen_args(params, _in_query_parameters),
        encoded=True,
