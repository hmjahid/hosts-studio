...
DOCUMENTATION = r"""
module: appliance_access_shell
short_description: Set enabled state of BASH, that is, access to BASH from within
    the controlled CLI.
...
options:
    ...
    timeout:
        ...
        - The timeout (in seconds) specifies how long you enable the Shell access.
            The maximum timeout is 86400 seconds(1 day). This parameter is mandatory.
        required: true
        type: int
    vcenter_hostname:
        description:
...
PAYLOAD_FORMAT = {
    "set": {
        "query": {},
        "body": {"enabled": "enabled", "timeout": "timeout"},
        "path": {},
    }
...
def prepare_argument_spec():
    ...
    argument_spec["timeout"] = {"required": True, "type": "int"}
...
async def _set(params, session):
    ...
    subdevice_type = get_subdevice_type("/api/appliance/access/shell")
