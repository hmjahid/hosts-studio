...
RETURN = r"""
# content generated by the update_return_section callback# task: Retrieve the CPU information from the VM
value:
  description: Retrieve the CPU information from the VM
  returned: On success
  sample:
    cores_per_socket: 1
    count: 1
