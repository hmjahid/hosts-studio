...
short_description: Get the global password policy.
...
RETURN = r"""
# content generated by the update_return_section callback# task: Get the global policy of the local accounts
value:
