...
RETURN = r"""
# content generated by the update_return_section callback# task: Get the system load status
value:
  description: Get the system load status
  returned: On success
  sample: green
  type: str
"""
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/api/appliance/health/load").format(**params)
...
async def _info(params, session):
    ...
    _url = ("https://{vcenter_hostname}" "/api/appliance/health/load").format(
        **params
